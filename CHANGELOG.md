...
- Added a versioned plugin API and capability contract with atomic registration validation, explicit network/storage declarations, schema-2 trust-manifest migration, and review/support inventory coverage.
